...
# Modeli eğit
model.train(
    data="/home/samet/Desktop/yolo-seg/train/data.yaml",           # Veri kümesi yapılandırması
    epochs=50,                  # Eğitim için epoch sayısı
    ...
    project="/home/samet/Desktop/yolo-seg/train/segmentation_runs", # Eğitim sonuçlarının kaydedileceği proje dizini
